...
export function AuthCard({ title, children }: AuthCardProps) {
  return (
    <section className="relative w-full max-w-[735px] overflow-hidden rounded-[42px] border-2 border-white/85 bg-white/[0.68] px-6 py-12 shadow-[0_30px_90px_rgba(44,34,22,0.16),inset_0_0_0_1px_rgba(255,255,255,0.5)] backdrop-blur-[38px] backdrop-saturate-150 sm:rounded-[56px] sm:border-white/75 sm:bg-white/[0.11] sm:px-12 sm:py-16 lg:px-16 lg:py-[86px]">
